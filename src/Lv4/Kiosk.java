...
//            if (choice == '1') {
//                System.out.println(burgerMenu.getName());
...
//                Arrays.asList(
//                        new MenuItem("코카콜라", 1.5, "'ㅍㅅ'같은 가짜콜라가 아닌 진짜 콜라!")
//                        ,new MenuItem("스프라이트", 1.5, "칠성보다 맛있는 절대존엄 사이다")
//                        ,new MenuItem("밀크쉐이크", 2.0, "다른 맛을 만들기 귀찮아서 배리에이션은 옆집 멍멍이나 줘버린 밀크쉐이크")
//                        ,new MenuItem("물", 0.8, "햄버거 먹으면서 물을? 진짜로? 굳이?")
//                ), "Drinks"
//        );
//
//        this.desserts = new Menu(
//                Arrays.asList(
//                        new MenuItem("슈크림 붕어빵 3pcs", 2.0, "팥붕의 시대는 갔다. 달콤한 슈크림 붕어빵")
//                        ,new MenuItem("애플 파이", 2.0, "난 이거 먹는 사람 잘 못봤는데 맛있나?")
//                        ,new MenuItem("치킨 너겟 6pcs", 2.0, "나의 의경시절을 달래준 영혼의 소울메이트")
//                        ,new MenuItem("왕밤빵", 4.5, "노력할만큼 했다 에라 모르겠는 메?뉴")
//                ), "Desserts"
//        );
//    }
